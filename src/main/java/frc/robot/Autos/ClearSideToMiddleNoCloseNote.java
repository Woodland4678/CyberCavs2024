...
public class ClearSideToMiddleNoCloseNote extends SequentialCommandGroup {
  
  /** Creates a new ClearSideToMiddleWoofer. */
  public ClearSideToMiddleNoCloseNote(SwerveSubsystem S_Swerve, Intake S_Intake, Arm S_Arm, Shooter S_Shooter, Climber S_Climber, Command[] Paths,  CommandXboxController notRealController, boolean isRedAlliance) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        ...
        //AutoBuilder.pathfindToPose(new Pose2d(new Translation2d(3.58, 2.89), new Rotation2d(Math.toRadians(-41.35))), new PathConstraints(4, 5, Units.degreesToRadians(540), Units.degreesToRadians(720))),     
      ...
      new AutoGrabNote(S_Swerve, S_Intake, true, notRealController, false),
      new ParallelRaceGroup(
        S_Swerve.findPath(PathPlannerPath.fromPathFile("ClearSideToMiddleNoCloseNote_1"), new PathConstraints(4, 5, Units.degreesToRadians(540), Units.degreesToRadians(720)), 0.5),
        //AutoBuilder.pathfindToPose(new Pose2d(new Translation2d(3.83, 2.86), new Rotation2d(Math.toRadians(-35.75))), new PathConstraints(4, 5, Units.degreesToRadians(540), Units.degreesToRadians(720))),     
        new AutoAdjustShooterAngle(S_Shooter, S_Intake, S_Swerve)       
      ),
      new AutoAim(S_Swerve, S_Shooter, S_Intake, notRealController, true),
      Paths[2],
      new AutoGrabNote(S_Swerve, S_Intake, true, notRealController, false),
      new ParallelRaceGroup(
        S_Swerve.findPathToPose(4.5, 5.35, -6.71, defaultContraints, isRedAlliance),
        //AutoBuilder.pathfindToPose(new Pose2d(new Translation2d(4.5, 5.35), new Rotation2d(Math.toRadians(-6.71))), new PathConstraints(4, 5, Units.degreesToRadians(540), Units.degreesToRadians(720))),     
        new AutoAdjustShooterAngle(S_Shooter, S_Intake, S_Swerve)             
      ),
      new AutoAim(S_Swerve, S_Shooter, S_Intake, notRealController, true)
      //S_Swerve.findPath(PathPlannerPath.fromPathFile("ClearSideToMiddleNoCloseNote_3"), new PathConstraints(4, 5, Units.degreesToRadians(540), Units.degreesToRadians(720)), 0.5),
    );
  }
}
